...
export declare enum LeadScoreTier {
    HOT = "HOT",
    WARM = "WARM",
    COLD = "COLD"
}
...
export declare enum LostReason {
    PRICE = "PRICE",
...
export type PermissionCode = 'LEAD_VIEW_ALL' | 'LEAD_VIEW_ASSIGNED' | 'LEAD_CREATE' | 'LEAD_UPDATE' | 'LEAD_DELETE' | 'LEAD_ASSIGN' | 'CALL_CREATE' | 'CALL_VIEW' | 'FOLLOWUP_CREATE' | 'FOLLOWUP_VIEW' | 'FOLLOWUP_UPDATE' | 'NOTE_CREATE' | 'NOTE_UPDATE' | 'NOTE_DELETE' | 'ACTIVITY_VIEW' | 'MEETING_CREATE' | 'MEETING_VIEW' | 'MEETING_UPDATE' | 'OPPORTUNITY_CREATE' | 'OPPORTUNITY_VIEW' | 'OPPORTUNITY_UPDATE' | 'PROPOSAL_CREATE' | 'PROPOSAL_VIEW' | 'PROPOSAL_UPDATE' | 'CUSTOMER_VIEW' | 'CUSTOMER_UPDATE' | 'REPORT_VIEW' | 'TEAM_VIEW' | 'USER_CREATE' | 'USER_VIEW' | 'USER_UPDATE' | 'USER_DELETE' | 'ROLE_MANAGE' | 'SYSTEM_SETTINGS' | 'AUDIT_LOG_VIEW' | 'LEAD_IMPORT' | 'LEAD_EXPORT';
...
export interface LeadScoreFactors {
    ...
    isRequirementConfirmed?: boolean;
    isVeryInterested?: boolean;
    isMeetingScheduled?: boolean;
    isQuotationRequested?: boolean;
    isWhatsappResponseReceived?: boolean;
}
